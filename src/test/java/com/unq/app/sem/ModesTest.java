...
public class ModesTest {
    ...
    public void automaticModeStrategyManageStartParking() {
        ...
        verify(app, times(1)).sendNotification("The parking start has been triggered automatically.");
    }
    ...
    public void automaticModeStrategyManageEndParking() {
        ...
        verify(app, times(1)).sendNotification("The end of parking has been triggered automatically.");
    }
    ...
    public void manualModeStrategyManageStartParking() {
        ...
        verify(app, times(1)).sendNotification("You haven't started the parking lot.");
    }
    ...
    public void manualModeStrategyManageEndParking() {
        ...
        verify(app, times(1)).sendNotification("You haven't finished parking.");
    }
}
